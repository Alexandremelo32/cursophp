...
<body>
    ...
    <section>
        ...
        <ul>
            <li><strong>Média Aritmética Simples</strong> entre os valores é igual a {<?=$ma?>}.</li>
            <li><strong>Média Aritmética Ponderada</strong> com pesos {<?=$peso1?>} e {<?=$peso2?>} é igual a {<?=$mp?>}.</li>
        </ul>
    </section>
